...
import com.fbcurso.cursoteste.servicos.ServicosCategoria;
...
@RequestMapping(value = "/categoria") /*Essa anotação define o mapeamento de URL base para todos os métodos dentro dessa classe de controlador.
...
public class recursosCategoria {
    ...
    public ResponseEntity<List<Categoria>> findAll() {
        ...
        List<Categoria> list = servicosCategoria.findAll();
    ...
    public ResponseEntity<Categoria> findById(@PathVariable Long id){  /* @PathVariable Long id: Essa anotação é usada para indicar que o valor do parâmetro id vem da parte da URL que corresponde ao {id} no mapeamento. 
