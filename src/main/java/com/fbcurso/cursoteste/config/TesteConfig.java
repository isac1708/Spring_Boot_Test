...
public class TesteConfig implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Pedido o1 = new Pedido(1L, Instant.parse("2019-06-20T19:53:07Z"), u1);
        Pedido o2 = new Pedido(2L, Instant.parse("2019-07-21T03:42:10Z"), u2);
        Pedido o3 = new Pedido(3L, Instant.parse("2019-07-22T15:21:22Z"), u1);
